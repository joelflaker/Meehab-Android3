...
public class RehabAdditionActivity extends SocketActivity implements
	...
	public void submitRehab() {
		...
		String typeOfRehabFacility = tvTypeOfRehabFacility.getText().toString()
				.trim();
		if(typeOfRehabFacility.toLowerCase().equals("othere")){
		...
		if (name.isEmpty()) {
			Toast.makeText(mContext, "Name should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}

		if (phone.isEmpty()) {
			Toast.makeText(mContext, "Phone should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}
		...
		if (email.isEmpty()) {
			Toast.makeText(mContext, "Email should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}
		...
		if (rehabName.isEmpty()) {
			Toast.makeText(mContext, "Rehab Name should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}
		if (webiste.isEmpty()) {
			Toast.makeText(mContext, "Website Name should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}
		if (typeOfRehabFacility.isEmpty()) {
			Toast.makeText(mContext,
					"Type of Rehab Facility should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}
		if (relationToRehab.isEmpty()) {
			Toast.makeText(mContext, "Name should not be empty!",
					Toast.LENGTH_SHORT).show();
			return;
		}
		...
		try {
			...
			json.put("codes", typeOfRehabFacility);
	...
	public void onSocketResponseSuccess(String event, Object obj) {
		...
		if (event.equals(EventParams.EVENT_ADD_REHAB)) {
			Toast.makeText(RehabAdditionActivity.this,
					"Rehab Addeded Successfully!", Toast.LENGTH_SHORT).show();
			onBackPressed();
		}
