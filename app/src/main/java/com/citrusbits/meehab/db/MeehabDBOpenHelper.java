...
public class MeehabDBOpenHelper extends SQLiteOpenHelper {
	...
	public static final String COLUMN_USER_CHECK_IN = "check_in";
	public static final String COLUMN_USER_NOTIFICATION = "notification";
	public static final String COLUMN_USER_FACEBOOK_ID = "facebook_id";
	...
	private static final String TABLE_CREATE_USER = "CREATE TABLE "
			...
			+ " INTEGER, " + COLUMN_USER_NAME + " TEXT, " + COLUMN_USER_CHECK_IN+ " TEXT, "
			+ COLUMN_USER_NOTIFICATION + " TEXT, " + COLUMN_USER_EMAIL
			+ " TEXT, " + COLUMN_PHONE + " TEXT, " + COLUMN_PICTURE + " TEXT, "+ COLUMN_INSURANCE + " TEXT, " 
			+ COLUMN_ACCUPATION + " TEXT, " + COLUMN_GENDER + " TEXT, " + COLUMN_DOB + " TEXT, "
			+ COLUMN_HOME_GROUP + " TEXT, " + COLUMN_MARITAL_STATUS + " TEXT, " + COLUMN_INTRESTED_IN
			+ " TEXT, " + COLUMN_ABOUT_STORY + " TEXT, " + COLUMN_USER_FACEBOOK_ID + " TEXT, "
