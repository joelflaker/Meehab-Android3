		...
		if(startTime.contains("am") && endTime.contains("am")) {
			...
			if(startTime.length() > 1) {
				...
				if(Integer.parseInt(startTime) < 9) {
					endTime = "0" + (Integer.parseInt(startTime) + 1) + ":00:00";
...
//
//		if(diff > -1 && diff < 7) {
//			date  = SmartDateTimeUtil.getDayString(SmartDateTimeUtil.getFutureDay(diff));
//		} else {
//			date  = simpleDate;
//		}
//
	...
	public static String getFormatedDate(String date){
		...
		if(date != null) {
			if(date.contains("-")) {
				...
				formatedDate = dateParts[1] + "-" + dateParts[2] + "-" + dateParts[0];
			} else {
				formatedDate = date;
			}
		} 
...
//	}
	...
	public static String getDatetimeAdded(String dateTimeAdded){

		//dateTimeAdded=dateTimeAdded.replace("T", " ");
	//	String date111[]=dateTimeAdded.split("\\.");
		//dateTimeAdded=dateTimeAdded.replace("Z", "");
		SimpleDateFormat dateFormate=new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
		SimpleDateFormat newDatetime=new SimpleDateFormat("dd MMM yyyy @ HH:mm a");
