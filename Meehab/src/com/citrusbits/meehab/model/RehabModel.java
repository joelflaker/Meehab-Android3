...
public class RehabModel implements Serializable{
	...
	private List<String> rehabPhotoesList = new ArrayList<>();
	private String name;
	...
	public List<String> getRehabPhotoes() {
		return rehabPhotoesList;
	}

	public void setRehabPhotoes(List<String> rehabPhotoes) {
		this.rehabPhotoesList = rehabPhotoes;
	}
